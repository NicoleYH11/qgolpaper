...
\nicole{[I like the choice of title---precise and suggestive of significance/applications.]}

\end{center}

\begin{abstract}
    Quantum information science often benefits from quantum extensions of classical game theory. Cellular automata are \sout{1-player} \nicole{one-player} games used in classical studies to generate complexity, \nicole{[I recommend splitting this sentence into two here.]} so quantum cellular automata can be similarly used to study the complexity of quantum many-body systems. \hl{Block cellular automata like Critters can develop a quantum analogy} 
\nicole{[What does ``Automata can develop a quantum analogy'' mean?]}    
by generalizing classical permutations of bit sequences to quantum circuits - 
\nicole{[I recommend turning this dash into a break between two sentences.]}
a two or three-qubit quantum circuit is extended to a time evolution acting on an entire $N$-qubit grid. Many quantum block cellular automata can be simulated exactly using a matrix product state despite exhibiting exotic entanglement structure, hence providing a testbed for measures of entanglement complexity. 
This analysis \hl{investigates} \nicole{[Humans are things of the sort that can investigate. Is an analysis something of the sort that can investigate?]} graphs formed by measures on two-qubit subsystems including mutual information, negativity and quantum concurrence. 
\nicole{[ $\leftarrow$ Details, examples \checkmark]}
Additionally, resulting states are compared to real-world systems in terms of area laws and correlation-length decay. 
\nicole{[Good to end with significance to real physics. \checkmark]}
\end{abstract}
...
\begin{Figure}
\centering
\includegraphics[width=0.8\textwidth]{Images/twoqubittime.png}
...
\begin{Figure}
\centering
\includegraphics[height=0.4\textwidth]{Images/bloch.png}
\includegraphics[height=0.4\textwidth]{Images/colormap.png}
...
\begin{Figure}
\centering
\includegraphics[height=0.4\textwidth]{Images/colorexamples/a.png}
\includegraphics[height=0.4\textwidth]{Images/colorexamples/b.png}
\includegraphics[height=0.4\textwidth]{Images/colorexamples/c.png}
\includegraphics[height=0.4\textwidth]{Images/colorexamples/d.png}
 \includegraphics[height=0.4\textwidth]{Images/colorexamples/e.png}
 \includegraphics[height=0.4\textwidth]{Images/colorexamples/f.png}
...
\includegraphics[height=0.3\textwidth]{Images/circuits/U3-2.png}
\hspace{4mm}
\includegraphics[height=0.3\textwidth]{Images/circuits/U3-2-T.png}

\textsc{twist}\hspace{2cm}
\textsc{twist-T}
\vspace{5mm}

\includegraphics[height=0.3\textwidth]{Images/circuits/U3.png}
...
\begin{Figure}
\centering
\includegraphics[width=0.9\textwidth]{Images/glider.png}
...
\begin{Figure}
\centering
\includegraphics[width=0.95\textwidth]{Images/moreentangled.png}
...
\begin{Figure}
\centering
\includegraphics[width=0.9\textwidth]{Images/mutinfonet.png}
...
\begin{Figure}
\centering
\includegraphics[width=0.9\textwidth]{Images/negativnet.png}
...
\begin{Figure}
\centering
\includegraphics[width=0.9\textwidth]{Images/concurrnet.png}
...
\begin{Figure}
\centering
\includegraphics[width=\textwidth]{Images/colorful.png}
...
\begin{Figure}
\centering
\includegraphics[width=\textwidth]{Images/arealaw.png}
...
\begin{Figure}
\centering
\includegraphics[width=0.9\textwidth]{Images/corrdecay.png}
